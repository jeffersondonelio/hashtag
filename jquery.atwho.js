	...
	EditableController.prototype.insert = function(content, $li) {
		...
		if(this.at == "@"){
			...
			this.query.el.removeClass('atwho-query')
				...
				.html("@"+content)
				.attr('href', "https://tappify.net/viewuser.php?id=" + data['id'])
				.attr('data-atwho-at-query', "" + data['atwho-at'] + this.query.text)
				.css({'font-weight':'bold'}).attr('contenteditable', "false");
		}else if(this.at == "#"){
			
			this.query.el.removeClass('atwho-query')
				.addClass('atwho-inserted')
				.html((content.includes("#")) ? content : "#"+content)
				.attr('href', "https://tappify.net/hashs.php?hash=" + content)
				.css({'font-weight':'bold'}).attr('contenteditable', "false");
		}
